...
joblib.dump(scaler, 'scaler.joblib')   # pretrained scaler is saved
...
# Health_Exp_Capita= st.number_input("Health Exp/Capita", min_value=0.0)
# Infant_Mortality_Rate= st.number_input("Infant Mortality Rate", min_value=0.0)
...
# Population_0to14= st.number_input("Population 0-14", min_value=0.0)
# Population_15to64= st.number_input("Population 15-64", min_value=0.0)
# Population_65above= st.number_input("Population 65+", min_value=0.0)
...
#     'Population 0-14': Population_0to14,
#     'Population 15-64': Population_15to64,
#     'Population 65+': Population_65above,
...
# 
# # Input validation
# if not all(input_df.isnull().sum() == 0):
