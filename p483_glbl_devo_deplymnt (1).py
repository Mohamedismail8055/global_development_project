...
subprocess.check_call(["pip", "install", "matplotlib"])  # matplotlib is installed because streamlit app is showing error
...
correlation_matrix = correlation_matrix[abs(correlation_matrix) > 0.3]
...
columns_to_remove = ['Business Tax Rate', 'Days to Start Business', 'Hours to do Tax','Lending Interest']
...
# features = ['Birth Rate', 'CO2 Emissions',
...
# scaled_input_data = scaler.fit_transform(input_df[numeric_columns]) # Use the loaded scaler
# 
# # Make the prediction
