...
# CO2_Emissions = st.number_input("Enter CO2 Emissions", min_value=0.0)
# Energy_Usage = st.number_input("Enter Energy Usage", min_value=0.0)
# Internet_Usage = st.number_input("Enter Internet Usage", min_value=0.0)
# 
